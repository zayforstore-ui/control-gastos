    ...
    for (const date of dates) {
      ...
      html += `
        <div class="mb-5">
          ...
          <div class="bg-slate-700 border border-slate-600 rounded-2xl divide-y divide-slate-600/50 overflow-hidden">
            ${items.map(t => `
              <div class="history-item flex items-center gap-3 px-4 py-3.5">
                ...
                <div class="flex-1 min-w-0">
                  <p class="text-sm font-medium text-slate-100 truncate">${this._escapeHtml(t.description)}</p>
                ...
                <button data-delete-id="${t.id}" class="btn-delete p-2 rounded-lg text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 transition-all" aria-label="Eliminar">
